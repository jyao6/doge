Dogestar::Application.routes.draw do
  ...
  #get '/forgot-password', to: 'user#forgot_password', as: 'forgot_password'
  #post '/forgot-password', to: 'user#request_reset'
  #match '/reset-password', to: 'user#reset_password',     via: ['get', 'post'], as: 'reset_password'
  #match '/change-password', to: 'user#change_password',     via: ['get', 'post'], as: 'change_password'
